...
Command: npx @threlte/gltf@1.0.0-next.0 ./muscle-car.glb -T -t --shadows -r /assets/basic-vehicle-controller/
-->
<script lang="ts">
  ...
  const gltf = useGltf<GLTFResult>(
    '/../../Users/grischaerbe/Documents/Projects/2022/threlte/apps/docs-next/public/assets/basic-vehicle-controller/muscle-car-transformed.glb',
    { useDraco: true }
  )
</script>
...
{#if $gltf}
  <T is={ref} {...$$restProps}>
    <T.Group scale={[0.37, 0.31, 2.2]}>
      <T.Mesh castShadow receiveShadow geometry={$gltf.nodes.Cube_1.geometry} material={$gltf.materials.Material} />
      <T.Mesh
        castShadow
        receiveShadow
